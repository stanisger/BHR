	...
	<script src="<?php bloginfo('template_url')?>/assets/js/retina-1.1.0.js"></script>
	<script src="<?php bloginfo('template_url')?>/assets/js/jquery.hoverdir.js"></script>
	<script src="<?php bloginfo('template_url')?>/assets/js/jquery.hoverex.min.js"></script>
